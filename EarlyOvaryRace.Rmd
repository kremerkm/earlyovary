...
raceKM <- ggsurvplot(fit.byRace.Group, HGS.ES, xlab = "Months", break.time.by = 12, break.y.by = 0.1, legend.title = "Race", title = "Survival of early stage HGSOC patients stratified by Race", legend.labs = c("White", "Hispanic", "Black", "Other"), legend = "bottom", palette = "Set1", ggtheme = theme_gray()) 
print(raceKM)
ggsave("raceKM.png", width = 7, height = 5, units = c("in"))
...
ph.ES <- coxph(Surv(SurvMonths, COD) ~ Age + Stage + Laterality + Chemotherapy + Race + Lymphadenectomy, data = HGS.ES)
