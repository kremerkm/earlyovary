...
ggsurvplot(fit.byRace.Group, HGS.ES, xlab = "Months", break.time.by = 12, break.y.by = 0.1, legend.title = "Race", title = "Survival of early stage HGSOC patients stratified by Race", legend.labs = c("White", "Hispanic", "Black", "Other"), legend = "bottom", palette = "Set1", ggtheme = theme_gray())
