...
ggsurvplot_facet(fit.byStageGroup, HGS.SG, facet.by = "Chemo", xlab = "Months", break.time.by = 12, break.y.by = 0.1, title = "Survival Stratified by Stage Group", legend.labs = c("I", "III", "IV"), legend.title = "Stage", legend = "bottom", palette = "Set1", ggtheme = theme_gray())
