...
ggsurvplot(fit.byLND, HGS.ES, xlab = "Months", break.time.by = 6, break.y.by = 0.1, title = "Survival of presumed early-stage HGSOC stratified by lymph node dissection", legend = "bottom", legend.title = "Lymphadenectomy", legend.labs = c("Adequate", "Inadequate", "None"))
```
```{r, echo = FALSE}
...
ggsurvplot(fit.N0.bychemo, HGS.N0, pval = TRUE, xlab = "Months", break.time.by = 6, break.y.by = 0.1, legend.title = "Received Chemotherapy", title = "Survival of T1N0M0 patients stratified by receipt of chemotherapy")
```
```{r, echo = FALSE}
knitr::knit_exit()
```
