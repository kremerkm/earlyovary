...
ggsurvplot(fit.byLND, HGS.ES, xlab = "Months", break.time.by = 12, break.y.by = 0.1, title = "Survival of presumed early-stage HGSOC stratified \nby adequacy of lymph node dissection", legend = "bottom", legend.title = "Lymphadenectomy", legend.labs = c("Adequate", "Inadequate", "None"), palette = "Set1", ggtheme = theme_gray())
...
fit.byLND2.chemo <- survfit(Surv(SurvMonths, COD) ~ LND2 + Chemo, data = HGS.ES)
ggsurvplot(fit.byLND2.chemo, HGS.ES, xlab = "Months", break.time.by = 12, break.y.by = 0.1, title = "Survival of presumed early-stage HGSOC stratified \nby lymph node dissection and receipt of chemotherapy", legend = "bottom", legend.title = "Lymphadenectomy", legend.labs = c("Yes, no Chemo", "Yes with Chemo", "No, no Chemo", "No with Chemo"), palette = "Set1", ggtheme = theme_gray())
