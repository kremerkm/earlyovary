...
KMbyLND.chemo <- ggsurvplot(fit.byLND.chemo, HGS.ES.chemo, xlab = "Months", break.time.by = 12, break.y.by = 0.1, title = "Survival of presumed early-stage HGSOC that \nreceived chemotherapy stratified by lymphadenectomy", legend = "bottom", legend.title = "Lymphadenectomy", legend.labs = c("Adequate", "Inadequate", "None"), palette = "Set1", ggtheme = theme_gray(), pval = TRUE)
...
KM.ES.chemo <- ggsurvplot(fit.ES.chemo, HGS.ES.chemo, pval = TRUE, xlab = "Months", break.time.by = 12, break.y.by = 0.1, legend.title = "Stage", legend = "bottom", legend.labs = c("T1N0M0", "T1NxMO"), title = "Survival of presumed early-stage HGSOC that\nreceived chemotherapy stratified by stage", palette = "Set1", ggtheme = theme_gray())
