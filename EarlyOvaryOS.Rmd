...
ggsurvplot(fit.byStage, data = HGS, test.for.trend = TRUE, xlab = "Months", break.time.by = 6, break.y.by = 0.1, title = "Survival Stratified by TNM Stage", legend.labs = c("T1N0M0", "T1NxM0", "T1N1M0", "Any M1"), legend.title = "Stage", legend = "bottom")
```
```{r, echo = FALSE}
...
ggsurvplot(fit.byLND, HGS.ES, xlab = "Months", break.time.by = 6, break.y.by = 0.1, title = "Survival of presumed early-stage HGSOC stratified \nby lymph node dissection", legend = "bottom", legend.title = "Lymphadenectomy", legend.labs = c("Adequate", "Inadequate", "None"))
```
```{r, echo = FALSE}
...
ggsurvplot(fit.ES.chemo, HGS.ES.chemo, pval = TRUE, xlab = "Months", break.time.by = 6, break.y.by = 0.1, legend.title = "Stage", legend.labs = c("T1N0M0", "T1NxMO"), title = "Survival of presumed early-stage HGSOC with chemotherapy")
```
...
ggsurvplot(fit.N0.bychemo, HGS.N0, pval = TRUE, xlab = "Months", break.time.by = 6, break.y.by = 0.1, legend.title = "Received Chemotherapy", title = "Survival of T1N0M0 patients stratified \nby receipt of chemotherapy", legend.labs = c("No/Unknown", "Yes"))
```
```{r, echo = FALSE}
knitr::knit_exit()
```
